...
class TestGlissade(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        assert car.battery.needs_service(), 'Battery does not need service?'
        self.assertTrue(car.needs_service())
...
class TestThovex(unittest.TestCase):
    ...
    def test_engine_should_not_be_serviced(self):
        ...
        car = Thovex(warning_light_is_on, current_mileage, last_service_mileage)
        assert not car.battery.needs_service(), 'Battery needs Service?'
        assert not car.engine.needs_service(), 'Engine needs Service?'
        self.assertFalse(car.needs_service())
